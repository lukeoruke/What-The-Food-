...
namespace Console_Runner.Logging
{
    public interface IUserIDGateway
    {
        ...
        public Task<string?> GetUserHashAsync(string idToGet);
        /// <summary>
        ...
        public Task<string> AddUserIdAsync(string idToAdd);
        /// <summary>
        ...
        public Task<bool> RemoveUserIdAsync(string idToRemove);
    }
}
