...
async function getIngs() {
    ...
    await fetch('http://47.151.24.23:49201/api/GetNIngredients?' + new URLSearchParams({page: page}))
...
async function getUserFlags(e) {
    ...
    deleteCurrentData(e);
    await fetch('http://47.151.24.23:49201/api/GetNAccountFlags?' + new URLSearchParams({
        page: page, token: jwt
    }))
        .then(async response => sessionStorage.setItem('allIngredients', JSON.stringify(await response.json())))
        //.then(data => console.log(data));
...
async function searchAccountFlags(e) {
    ...
    try {
        ...
        await fetch('http://47.151.24.23:49201/api/GetAccountFlagBySearch?' + new URLSearchParams({
...
async function searchIngs(e) {
    ...
    await fetch('http://47.151.24.23:49201/api/FlagSearchIngredients?' + new URLSearchParams({
...
async function sendNewFlag(e) {
    ...
    await fetch('http://47.151.24.23:49201/api/AccountAddFlags?' + new URLSearchParams({
        token: jwt
    }), {
        method: 'POST',
        headers: {
...
async function removeFlag(e) {
    ...
    await fetch('http://47.151.24.23:49201/api/AccountRemoveFlag?' + new URLSearchParams({
        page: page, token: jwt
    }), {
        method: 'POST',
        headers: {
