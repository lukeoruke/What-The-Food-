        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodItemBarcode = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodUpdates", x => new { x.FoodItemId, x.UpdateTime });
                    table.ForeignKey(
                        name: "FK_FoodUpdates_FoodItem_FoodItemBarcode",
                        column: x => x.FoodItemBarcode,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodUpdates_FoodItemBarcode",
                table: "FoodUpdates",
                column: "FoodItemBarcode");
        }
