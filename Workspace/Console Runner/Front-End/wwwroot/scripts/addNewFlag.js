...
async function getIngs() {
    ...
    await fetch('http://47.151.16.249:49202/api/GetNIngredients?' + page)
...
async function getUserFlags(e) {
    ...
    deleteCurrentData(e);
    await fetch('http://47.151.16.249:49202/api/GetNAccountFlags?' + page)
        .then(async response => localStorage.setItem('allIngredients', JSON.stringify(await response.json())))
        .then(data => console.log(data));
...
async function searchAccountFlags(e) {
    ...
    try {
        ...
        await fetch('http://47.151.16.249:49202/api/GetAccountFlagBySearch?' + search + "?" + page)
            .then(async response => localStorage.setItem('allIngredients', JSON.stringify(await response.json())))
            .then(data => console.log(data));
...
async function searchIngs(e) {
    ...
    await fetch('http://47.151.16.249:49202/api/FlagSearchIngredients?' + search + "?" + page)
        .then(async response => localStorage.setItem('allIngredients', JSON.stringify(await response.json())))
        .then(data => console.log(data));
...
async function sendNewFlag(e) {
    ...
    await fetch('http://47.151.16.249:49202/api/AccountAddFlags', {
        method: 'POST',
        headers: {
...
async function removeFlag(e) {
    ...
    await fetch('http://47.151.16.249:49202/api/AccountRemoveFlag?' + page, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Access-Control-Origin': '*',
